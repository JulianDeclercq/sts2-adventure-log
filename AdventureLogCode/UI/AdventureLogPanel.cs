...
public partial class AdventureLogPanel : Control
{
    ...
    private static RenderItem? CreateStandaloneItem(LogEvent evt) => evt switch
    {
        CardPlayEvent card => new CardRenderItem(card,
            new List<DamageReceivedEvent>(), new List<PowerReceivedEvent>(),
            new List<CardRecallEvent>(), new List<EnergyDeltaEvent>(),
            new List<CardDrawEvent>(), new List<CardDiscardEvent>(),
            new List<CardExhaustEvent>(), new List<BlockGainedEvent>(),
            new List<CardUpgradeEvent>(), new List<CardGeneratedEvent>()),
        DamageReceivedEvent damage => new DamageRenderItem(damage),
        RelicProcEvent relic => new RelicRenderItem(relic,
            new List<DamageReceivedEvent>(), new List<PowerReceivedEvent>(),
            new List<EnergyDeltaEvent>()),
        ...
        PotionUsedEvent potion => new PotionRenderItem(potion,
            new List<DamageReceivedEvent>(), new List<PowerReceivedEvent>(),
            new List<BlockGainedEvent>(), new List<EnergyDeltaEvent>(),
            new List<CardUpgradeEvent>(), new List<CardGeneratedEvent>()),
